#!/usr/bin/env bash          ## TD I did a test edit on this one to use to compare with the one I used
...
HOSTSERIAL='38FFDD053348523722842451-if00'
...
TOOLHEADSERIALS=('56FF6C067166555620240387-if00') # For multiple serials use: TOOLHEADSERIALS=('SERIAL_1' 'SERIAL_2' 'SERIAL_3')
